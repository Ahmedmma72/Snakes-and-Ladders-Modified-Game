...
private:	
	...
	void completeladdertop(const CellPosition& fromCell)   const;
	void completeladderbody(const CellPosition& fromCell)const;
	void completesnaketail(const CellPosition& fromCell)   const;
	void completesnakebody(const CellPosition& fromCell)   const;

public:
	//void basicdrawcell(const CellPosition& cellPos, int cardNum)const;
