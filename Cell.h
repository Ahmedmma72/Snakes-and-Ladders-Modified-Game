...
public:
	...
	int GetCellNumFromPosition(CellPosition& cellPosition) const;  // a getter for the number of the position
	CellPosition GetCellPositionFromNum(int cellNum) const;     // a getter for the position of the cell number
	...
	void SetGameObjectToNull();                                          // then draw all ladders/snake, in order to avoid overlapping 
